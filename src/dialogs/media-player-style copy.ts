export const mediaPlayerCardMod = {
    style: `
        mxmp-player$ {
            mxmp-player-header$ .entity {
                color: rgb(var(--sq-primary-font-rgb));
                font-weight: var(--sq-primary-font-weight);
                font-size: var(--sq-primary-font-size);
            }
            mxmp-player-controls$ .icons {
                margin-bottom: 1rem;
                gap: 1rem;
            }
            mxmp-player-controls$ mxmp-ha-player, mxmp-player-controls$ ha-icon-button {
