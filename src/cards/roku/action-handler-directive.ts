...
export const actionHandler: Directive<PartInfo> = directive<PartInfo>((options: ActionHandlerOptions = {}) => (part: PropertyPart): void => {

export const actionHandler: Directive<PartInfo> = directive((options: ActionHandlerOptions = {}) => (part: PropertyPart): void => {
