...
window.customCards.push({
    type: "smartqasa-light-grid-tile",
    name: "SmartQasa Light Grid Tile",
    preview: true,
    description: "A SmartQasa tile for controlling a groupd of light entities displayed in a grid.",
});

@customElement("smartqasa-light-grid-tile")
export class LightGridTile extends LitElement implements LovelaceCard {
