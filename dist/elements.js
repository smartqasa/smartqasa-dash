...
`;
  ...
  let SmartQasaTimeDate = class SmartQasaTimeDate extends s {
      ...
      set hass(hass) {
          var _a, _b, _c, _d;
          this._hass = hass;
          this._time = (_b = (_a = this._hass) === null || _a === void 0 ? void 0 : _a.states["sensor.current_time"].state) !== null && _b !== void 0 ? _b : "unavailable";
          this._date = (_d = (_c = this._hass) === null || _c === void 0 ? void 0 : _c.states["sensor.current_date"].state) !== null && _d !== void 0 ? _d : "unavailable";
      }
      static get styles() {
          return i$2 `
      :host {
  ...
  let SmartQasaAreaTile = class SmartQasaAreaTile extends s {
    ...
    `;
      ...
      _navigate(e) {
          ...
          e.stopPropagation();
          if (this._areaObj) {
              de(null, `/home-dash/${this._area}`, false);
